...
public class ItrWorkAL 
{
    ...
    A: itr.next() is not typecase as an integer  ?
    FIX: do Iterator<Integer> itr = L.iterator();
    */
	...
	while( itr.hasNext() ) {
	    Integer tmp = itr.next(); //Q: Why this line necessary? you have to temp store the value of the next item 
	    if ( tmp % 2 == 1 )
		retL.add( tmp );
	}
	return retL;
